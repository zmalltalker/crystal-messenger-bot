...
describe Messenger::Bot do
  it "builds a message" do
    ...
    result = builder.build_text_message(42, "Whoa")
    result.recipient.recipient_id.should eq(42)
    result.message.text.should eq("Whoa")
  end

  it "delivers a message to Messenger's API" do
    message = Messenger::Bot::Builder.new.build_text_message(42, "Hullo there")
    access_token = "sikret"
